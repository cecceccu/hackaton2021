...
class Slider:
    def __init__(self, position:tuple, upperValue:int=25, sliderWidth:int = 25, text:str="Simulation speed ",
                 outlineSize:tuple=(200, 100))->None:
    ...
    def getValue(self)->float:
        return 5 + self.sliderWidth / (self.outlineSize[0] / self.upperValue) 
    ...
    def render(self, display:pygame.display)->None:
        ...
        valueSurf = self.font.render(f"{self.text}: x{self.getValue()/10}", True, (255, 0, 0))
